...
assert len(data_2026.first_detection_years) == 325
assert data_2026.show_facility_markers is False
assert count_at_year(data_2026, 2019) == 214
assert count_at_year(data_2026, 2020) == 220
assert count_at_year(data_2026, 2021) == 259
assert count_at_year(data_2026, 2024) == 325
assert count_at_year(data_2026, 2026) == 325
...
assert np.isclose(trends_2026["2021-2026"], 14.228571428571437)
...
assert np.isclose(trends_current["2021-Present"], 14.228571428571437)
